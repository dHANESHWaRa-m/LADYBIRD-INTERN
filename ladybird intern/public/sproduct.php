...
<section id="prodetails" class="section-p1">
    <div class="single-pro-image">
        <img src="/ladybird intern/img/products/f1.jpg" width="100%" id="MainImg" alt="">
        <div class="small-img-group">

        <div class="small-img-col">
            <img src="/ladybird intern/img/products/f1.jpg" width="100%" class="small-img" alt="">

        </div>
        <div class="small-img-col">
            <img src="/ladybird intern/img/products/f2.jpg" width="100%" class="small-img" alt="">

        </div>
        <div class="small-img-col">
            <img src="/ladybird intern/img/products/f3.jpg" width="100%" class="small-img" alt="">

        </div>
        <div class="small-img-col">
            <img src="/ladybird intern/img/products/f4.jpg" width="100%" class="small-img" alt="">
...
<div class="single-pro-details">
    ...
    <span>Hello Hello this is wonderful dress u know</span>  
 ...
 <section id="product1" class="section-p1">
        ...
        <a href="#"><i class="fa-duotone fa-solid fa-cart-shopping CART"></i></a>
